...
@section('content')
  <section class="relative overflow-hidden">
    ...
    <div class="section-shell relative pt-12 pb-6 lg:pt-16 lg:pb-10 grid gap-8 lg:grid-cols-[1.2fr,1fr] items-center">
      <div class="space-y-6">
        <div class="eyebrow">Nueva experiencia de compra</div>
        <div class="space-y-3">
          ...
          <p class="text-lg text-gray-600 leading-relaxed">Explora productos frescos, selecciona tus favoritos y recibe tu compra sin complicaciones. Todo el contenido está jerarquizado para que encuentres lo esencial en segundos.</p>
        </div>
      ...
      <div class="relative">
        <div class="glass-panel p-6 shadow-2xl space-y-3">
          <div class="text-sm font-semibold text-blue-700">Filtros inteligentes</div>
          <p class="text-2xl font-bold text-gray-900 leading-tight">Encuentra rápido lo que necesitas</p>
          <p class="text-sm text-gray-600 leading-relaxed">Combina búsqueda, categorías y ordenamientos. El panel mantiene el diseño del contenido pero ordena la información clave.</p>
          <div class="flex flex-wrap gap-2">
            <span class="stat-slim">📦 Stock en tiempo real</span>
            <span class="stat-slim">✨ Descripciones concisas</span>
            <span class="stat-slim">🧭 Jerarquía clara</span>
          </div>
          <form method="GET" action="{{ route('catalog.index') }}" class="pt-2 grid grid-cols-1 gap-4">
            <div>
  ...
  <div class="section-shell py-10">
    <div class="section-heading mb-6">
      <div class="space-y-1">
        <div class="section-title">Explora el catálogo</div>
        <p class="section-subtitle">Diseño de contenido simplificado: cards limpias, información primaria al frente y acciones destacadas sin ruido.</p>
      </div>
      <div class="flex flex-wrap gap-2">
        <span class="badge-pill bg-blue-50 text-blue-700">Entrega segura</span>
        <span class="badge-pill bg-emerald-50 text-emerald-700">Productos verificados</span>
        <span class="badge-pill bg-amber-50 text-amber-700">Ofertas activas</span>
      </div>
    </div>
          ...
          <div class="p-5 flex flex-col gap-4 flex-1">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex flex-col items-end gap-1 text-xs text-gray-500">
                <span class="stat-slim">📍 Revisión rápida</span>
                <a href="{{ route('catalog.show', $product) }}" class="inline-flex items-center gap-1 text-blue-700 font-semibold">
                  Ver detalles
            ...
            <div class="mt-auto flex flex-wrap items-center gap-3 border-t border-slate-100 pt-4">
